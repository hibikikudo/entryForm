    ...
    return function (t) {
            ...
            var i = function () {
                ...
                c = function () {
                    function t(e, n) {
                        ...
                        this.onSubmit = "function" == typeof n
                            ? n
                            : function () {},
                            ...
                            .on("submit", function (t) {
                                ...
                                n.forEach(function (t) {
                                    ...
                                    if (!(!o || "fieldset" == e.prop("tagName") || e.prop("disabled") || "reset" == n || "submit" == n || "button" == n || "file" == n || o in a)) {
                                        ...
                                        var s = null;
                                        "radio" == n
                                            ? u["default"]('[name="' + o + ']"', i).each(function (t) {
                                                var e = u["default"](t);
                                                e.checked() && (s = e.val())
                                            })
                                            : s    = "checkbox" == n
                    ...
                    return i(t, [
                        {
                            ...
                            value: function (t) {
                                ...
                                return t.each(function (t) {
                                    ...
                                    r.valid
                                        ? n
                                            .setState("valid", !0, e.$form)
                                            .setState("invalid", !1, e.$form)
                                        : n
                                            .setState("invalid", !0, e.$form)
                                            .setState("valid", !1, e.$form);
                                    var a = u["default"]('[data-errors-for="' + n.attr("name") + '"]', e.$form),
                                        i = void 0;
                                    a.each(function (t) {
                                        for (var e in r) 
                                            r.hasOwnProperty(e) && (i = u["default"]('[data-errors-when="' + e + '"]', t), r[e]
                                                ? i.show()
                                                : i.hide())
                                        })
                                }),
        ...
        function (t, e, n) {
            ...
            u["default"].fn.setState = function (t, e, n) {
                "invalid" == t && e === !0 || "valid" == t && e === !1
                    ? this.aria("invalid", !0)
                    : ("invalid" == t && e === !1 || "valid" == t && e === !0) && this.aria("invalid", !1);
                var r = "is-" + t,
        ...
        function (t, e, n) {
            ...
            a = function () {
                function t(e) {
                    ...
                    e instanceof t
                        ? this._elements = e.get()
                        : "string" == typeof e
                            ? this._elements = []
                                .slice
                                .call(n.querySelectorAll(e))
                            : e instanceof Array
                                ? this._elements = e
                                : this._elements = [e]
                }
                        ...
                        var r = function () {
                            ...
                            return r.forEach(function (e) {
                                if (i = new t(e), ["button", "submit"].indexOf(i.attr("type")) < 0 && "button" != i.tagName) {
                                    ...
                                    n
                                        .children
                                        .push({element: e, validity: a});
                                    for (var r in a) 
                                        a.hasOwnProperty(r) && (void 0 === n[r] && (n[r] = a[r]), "valid" == r
                                            ? a[r] === !1 && (n.valid = !1)
                                            : a[r] === !0 && (n[r] = !0))
                                    }
                            }), {v: n}
                    ...
                    return this
                        ...
                        .forEach(function (t) {
                            ...
                            a.valid
                                ? void 0 !== n[t.name]
                                    ? r = a[t.name] = n[t.name]
                                    : "function" == typeof t.isInvalid
                                        ? r = a[t.name] = t.isInvalid(e)
                                        : a[t.name] = !1
                                : a[t.name] = !1,
                            r && (a.valid = !1)
                        }),
